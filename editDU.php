        ...
        <div class="card-body">
            ...
            <form action="" id="manage_user">
                ...
                <div class="col-lg-12 text-right justify-content-center d-flex">
                    ...
                    <button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=department_user'">Cancel</button>
                </div>
            </form>
        </div>
    </div>
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp == 1) {
                    ...
                    setTimeout(function() {
                        location.replace('index.php?page=department_user')
                    }, 750)
                } else if (resp == 2) {
